...
export const BUILT_IN_WORKFLOWS: OpenSpecterWorkflow[] = [
    // ─── IP Licensing Agreement ──────────────────────────────────────────────────
    {
        id: "builtin-ip-licensing",
        user_id: null,
        is_system: true,
        created_at: "",
        title: "IP Licensing Agreement Review",
        type: "tabular",
        practice: "IP / Technology",
        prompt_md: null,
        columns_config: [
            {
                index: 0,
                name: "Licensor",
                format: "text",
                prompt: "Who is the licensor under this agreement? State the full legal name, jurisdiction of incorporation, and any group/affiliate entities included in the licensor definition.",
            },
            {
                index: 1,
                name: "Licensee",
                format: "text",
                prompt: "Who is the licensee under this agreement? State the full legal name, jurisdiction of incorporation, and whether affiliates are included.",
            },
            {
                index: 2,
                name: "Effective Date",
                format: "date",
                prompt: "What is the effective date or commencement date of this licence?",
            },
            {
                index: 3,
                name: "Licensed IP",
                format: "bulleted_list",
                prompt: "What intellectual property is licensed? List each item by category (patents, trademarks, copyrights, software, know-how, trade secrets) and identify any specific assets, registration numbers, or schedules referenced.",
            },
            {
                index: 4,
                name: "Field of Use",
                format: "text",
                prompt: "What field of use applies to the licence? Describe any limitations on the products, services, industries, or applications in which the licensed IP may be used.",
            },
            {
                index: 5,
                name: "Territory",
                format: "text",
                prompt: "In what territory may the licensee exploit the licensed IP? State any geographic limitations and whether the licence is worldwide.",
            },
            {
                index: 6,
                name: "Exclusivity",
                format: "tag",
                tags: ["Exclusive", "Sole", "Non-Exclusive"],
                prompt: "Is the licence exclusive, sole, or non-exclusive? Note any field- or territory-specific exclusivity, and identify any rights the licensor retains.",
            },
            {
                index: 7,
                name: "Term & Renewal",
                format: "text",
                prompt: "What is the term of the licence? State the initial term, any automatic renewal mechanism, the renewal period, and notice required to prevent renewal.",
            },
            {
                index: 8,
                name: "Royalty / Fee Structure",
                format: "text",
                prompt: "What royalties or fees are payable? Describe upfront fees, milestone payments, running royalties (rate, royalty base, stacking), and any minimum royalties. Note the currency and payment cadence.",
            },
            {
                index: 9,
                name: "Audit Rights",
                format: "text",
                prompt: "What audit rights does the licensor have over royalty calculations? Describe the frequency, notice required, who bears the cost (and any threshold for cost-shifting), and the records the licensee must keep.",
            },
            {
                index: 10,
                name: "Sublicensing Rights",
                format: "text",
                prompt: "May the licensee sublicense the IP? If so, on what terms — does it require licensor consent, are there pass-through royalty obligations, and must sublicensees be bound by equivalent terms?",
            },
            {
                index: 11,
                name: "Improvements / Derivatives",
                format: "text",
                prompt: "Who owns improvements, modifications, or derivative works of the licensed IP? Identify any grant-back licence to the licensor, and any restrictions on the licensee's freedom to develop improvements.",
            },
            {
                index: 12,
                name: "Quality Control / Brand Standards",
                format: "text",
                prompt: "What quality control or brand-standard obligations apply (especially for trademark licences)? Identify any approval, inspection, sampling, or style-guide compliance requirements.",
            },
            {
                index: 13,
                name: "IP Infringement & Indemnity",
                format: "text",
                prompt: "How is third-party IP infringement addressed? Describe each party's indemnity obligations, who controls defence and settlement, and who bears the cost of enforcing the IP against infringers.",
            },
            {
                index: 14,
                name: "Termination Triggers",
                format: "bulleted_list",
                prompt: "On what grounds may either party terminate? List each termination trigger (e.g. material breach with cure period, insolvency, change of control, challenge to validity, failure to meet milestones).",
            },
            {
                index: 15,
                name: "Effect of Termination",
                format: "text",
                prompt: "What happens to licence rights, sublicences, inventory, and confidential information on termination? Identify any wind-down/sell-off period, return-or-destroy obligations, and post-termination restrictions.",
            },
            {
                index: 16,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law applies and which courts or arbitral tribunals have jurisdiction over disputes?",
            },
            {
                index: 17,
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes resolved? Identify whether disputes go to litigation or arbitration, the seat or forum, the rules (if arbitration), and any mandatory escalation steps.",
            },
        ],
    },
    ...
    // ─── MSA / SaaS Agreement ────────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "MSA / SaaS Agreement Review",
        type: "tabular",
        practice: "Commercial",
        prompt_md: null,
        columns_config: [
            {
                ...
                name: "Provider",
                format: "text",
                prompt: "Who is the service provider under this agreement? State the full legal name and jurisdiction of incorporation.",
            },
            {
                index: 1,
                name: "Customer",
                format: "text",
                prompt: "Who is the customer under this agreement? State the full legal name and jurisdiction of incorporation, and note whether customer affiliates may use the services.",
            },
            {
                index: 2,
                name: "Effective Date",
                format: "date",
                prompt: "What is the effective date of the master agreement, and what is the date or term of any order form being analysed alongside it?",
            },
            {
                index: 3,
                name: "Service Description",
                format: "text",
                prompt: "Summarise the services or SaaS subscription provided. Identify the modules or product tiers, scope of access, and any usage limits (e.g. seat counts, API call caps, storage caps).",
            },
            {
                index: 4,
                name: "SLA & Uptime",
                format: "text",
                prompt: "What service-level commitments apply? State the uptime target, how it is calculated (including any exclusions for scheduled maintenance or force majeure), and the measurement period.",
            },
            {
                index: 5,
                name: "Service Credits",
                format: "text",
                prompt: "What service credits are payable for SLA failures? State the credit calculation, any cap on credits, whether credits are the exclusive remedy, and any termination right for chronic failures.",
            },
            {
                index: 6,
                name: "Data Processing / DPA",
                format: "text",
                prompt: "Is a data processing addendum (DPA) referenced or attached? Identify the controller/processor designation, sub-processor approval mechanism, and any cross-border transfer mechanism (e.g. SCCs, IDTA, DPF).",
            },
            {
                index: 7,
                name: "Security & Audit Rights",
                format: "text",
                prompt: "What information security obligations apply (e.g. ISO 27001, SOC 2, encryption standards)? What audit, attestation, or pen-test rights does the customer have, and how often may they be exercised?",
            },
            {
                index: 8,
                name: "Support",
                format: "text",
                prompt: "What support is provided? State the support tiers, response/resolution times by severity, support hours, and channels (e.g. email, portal, telephone).",
            },
            {
                index: 9,
                name: "Fees & Payment",
                format: "text",
                prompt: "What fees are payable? State the pricing model (subscription, usage-based, tiered), payment terms (net-30, net-60), invoicing cadence, and any price-increase mechanism on renewal.",
            },
            {
                index: 10,
                name: "Auto-Renewal",
                format: "yes_no",
                prompt: "Does the agreement auto-renew? Answer Yes or No. If Yes, state the renewal period, the notice required to prevent renewal, and any price increase that applies on renewal.",
            },
            {
                index: 11,
                name: "Term & Termination",
                format: "text",
                prompt: "What is the initial term and what termination rights does each party have? Distinguish between termination for convenience (notice period) and termination for cause (cure periods, triggers).",
            },
            {
                index: 12,
                name: "Suspension Rights",
                format: "text",
                prompt: "Under what circumstances may the provider suspend the services (e.g. non-payment, breach, security risk)? What notice is required and when must service be restored?",
            },
            {
                index: 13,
                name: "IP Ownership",
                format: "text",
                prompt: "How is IP ownership allocated? Identify ownership of provider IP, customer data, customer-specific configurations, and feedback. Note any licence the provider receives over feedback or aggregated usage data.",
            },
            {
                index: 14,
                name: "Source-Code Escrow",
                format: "yes_no",
                prompt: "Is there a source-code escrow arrangement? Answer Yes or No. If Yes, identify the escrow agent, the release triggers, and any ongoing fees.",
            },
            {
                index: 15,
                name: "Acceptable Use",
                format: "text",
                prompt: "Summarise the acceptable use policy. Identify prohibited uses (e.g. high-risk applications, illegal content, reverse engineering, benchmarking) and the consequences of breach.",
            },
            {
                index: 16,
                name: "Limitation of Liability",
                format: "text",
                prompt: "What limitations of liability apply? Identify caps on liability (and how calculated, e.g. fees paid in the prior 12 months), exclusions of consequential / indirect / lost profits, and carve-outs from the cap (e.g. confidentiality breach, IP indemnity, data breach, fraud).",
            },
            {
                index: 17,
                name: "Indemnities",
                format: "text",
                prompt: "What indemnities are given? Cover IP infringement (and any 'replace, modify, refund' remedy ladder), data-breach indemnity, and any customer indemnity for misuse. Note any exclusions or sole-remedy language.",
            },
            {
                index: 18,
                name: "Insurance",
                format: "text",
                prompt: "What insurance must each party maintain? State the types (e.g. cyber, professional indemnity, public liability) and the minimum coverage amounts.",
            },
            {
                index: 19,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law applies to this agreement and which courts have jurisdiction?",
            },
            {
                index: 20,
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes resolved? Identify whether disputes go to litigation or arbitration, the seat or forum, applicable rules, and any mandatory escalation or mediation steps.",
            },
        ],
    },
    ...
    // ─── Asset Purchase Agreement ────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Asset Purchase Agreement Review",
        type: "tabular",
        practice: "Corporate",
        prompt_md: null,
        columns_config: [
            {
                ...
                name: "Parties",
                format: "bulleted_list",
                prompt: "Identify all parties to this asset purchase agreement. For each, state full legal name, jurisdiction, and role (seller, buyer, target, parent guarantor).",
            },
            {
                index: 1,
                name: "Date",
                format: "date",
                prompt: "What is the date of this asset purchase agreement?",
            },
            {
                index: 2,
                name: "Purchased Assets",
                format: "bulleted_list",
                prompt: "What assets are being acquired? List each category (e.g. tangible assets, contracts, IP, goodwill, books and records, employees, real estate, inventory) and identify the relevant schedule references.",
            },
            {
                index: 3,
                name: "Excluded Assets",
                format: "bulleted_list",
                prompt: "What assets are expressly excluded from the sale? List each category and any related schedule.",
            },
            {
                index: 4,
                name: "Assumed Liabilities",
                format: "bulleted_list",
                prompt: "What liabilities does the buyer assume? List each category (e.g. contractual obligations going forward, accrued employee entitlements, specified product warranties).",
            },
            {
                index: 5,
                name: "Excluded Liabilities",
                format: "bulleted_list",
                prompt: "What liabilities are retained by the seller? List each category (e.g. pre-completion tax, litigation, environmental, employment claims).",
            },
            {
                index: 6,
                name: "Purchase Price",
                format: "monetary_amount",
                prompt: "What is the headline purchase price? State the currency, the structure (cash, deferred consideration, earnout, share consideration), and any locked-box or completion-accounts adjustment mechanism.",
            },
            {
                index: 7,
                name: "Price Allocation",
                format: "text",
                prompt: "How is the purchase price allocated across asset classes for tax purposes? Identify the allocation schedule and any agreed treatment for tax filings.",
            },
            {
                index: 8,
                name: "Conditions Precedent",
                format: "bulleted_list",
                prompt: "List the conditions precedent to completion (e.g. regulatory clearances, third-party consents, no material adverse change). Identify the long-stop date.",
            },
            {
                index: 9,
                name: "Completion Mechanics",
                format: "text",
                prompt: "Describe the completion mechanics. State how many business days after CP satisfaction completion occurs, the place of completion, and the deliverables of each party at completion.",
            },
            {
                index: 10,
                name: "Title & Risk Transfer",
                format: "text",
                prompt: "When does title and risk in the assets transfer to the buyer? Identify any specific assets that require separate transfer mechanics (e.g. real estate transfers, IP assignments, contract novations).",
            },
            {
                index: 11,
                name: "Warranties",
                format: "text",
                prompt: "Summarise the warranty package. Who warrants (seller, parent guarantor)? Distinguish business warranties from title/capacity warranties. Identify the disclosure mechanism.",
            },
            {
                index: 12,
                name: "Indemnities",
                format: "bulleted_list",
                prompt: "List specific indemnities given (e.g. tax indemnity, environmental, litigation, product liability). For each, note the indemnifier, scope, time limit, and any cap.",
            },
            {
                index: 13,
                name: "Limitation of Liability",
                format: "text",
                prompt: "What limitations apply to warranty/indemnity claims? Identify the aggregate cap, any separate cap for fundamental warranties, the de minimis and basket/threshold, and time limits for bringing claims (general, tax, fundamental).",
            },
            {
                index: 14,
                name: "Restrictive Covenants",
                format: "text",
                prompt: "What non-compete, non-solicitation, and non-dealing covenants does the seller give? State the scope (activities and geography) and duration of each.",
            },
            {
                index: 15,
                name: "Transitional Services",
                format: "text",
                prompt: "Are there transitional services arrangements (TSA)? Identify the services to be provided post-completion, the duration, the charging model, and any exit assistance.",
            },
            {
                index: 16,
                name: "Employee Transfer",
                format: "text",
                prompt: "How are employees transferred? Identify whether TUPE / ARD / equivalent automatic-transfer legislation applies, any consultation obligations, and how accrued entitlements (holiday, bonuses, pensions) are handled.",
            },
            {
                index: 17,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law applies to this agreement and which courts or arbitral tribunals have jurisdiction?",
            },
            {
                index: 18,
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes resolved? Identify the forum, applicable rules, and any mandatory pre-dispute escalation steps.",
            },
        ],
    },
    ...
    // ─── Joint Venture Agreement ─────────────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Joint Venture Agreement Review",
        type: "tabular",
        practice: "Corporate",
        prompt_md: null,
        columns_config: [
            {
                index: 0,
                name: "JV Parties & Equity Split",
                format: "bulleted_list",
                prompt: "Identify the JV parties. For each, state full legal name, jurisdiction, equity percentage in the JV vehicle, and class of shares held.",
            },
            {
                index: 1,
                name: "JV Vehicle",
                format: "text",
                prompt: "Describe the JV vehicle: legal form (e.g. company, LLP, partnership), jurisdiction, name, and registration details where stated.",
            },
            {
                index: 2,
                name: "Business Scope",
                format: "text",
                prompt: "What is the business scope of the JV? Identify permitted activities, geographic scope, and any exclusivity (e.g. parties cannot compete with the JV in the field).",
            },
            {
                index: 3,
                name: "Initial Capital Contributions",
                format: "text",
                prompt: "What are the initial capital contributions? State each party's commitment, the form (cash, IP, assets, services), and the timing of contributions.",
            },
            {
                index: 4,
                name: "Future Funding",
                format: "text",
                prompt: "How will future funding be provided? Identify the mechanism (equity calls, shareholder loans, third-party debt), pro-rata obligations, and consequences for failing to fund (e.g. dilution, default sale).",
            },
            {
                index: 5,
                name: "Board Composition",
                format: "text",
                prompt: "How is the board constituted? State the total number of directors, each party's appointment rights (and the shareholding threshold required to maintain them), the chairman, and any casting vote.",
            },
            {
                index: 6,
                name: "Reserved Matters",
                format: "bulleted_list",
                prompt: "List the reserved matters / veto rights — decisions requiring unanimity, special majority, or a specific party's consent. Identify the threshold for each.",
            },
            {
                index: 7,
                name: "Deadlock Resolution",
                format: "text",
                prompt: "How are deadlocks resolved? Describe escalation steps (CEO-level, chairman-level, mediation) and any ultimate mechanism (Russian roulette, Texas shoot-out, put/call options, mandatory sale).",
            },
            {
                index: 8,
                name: "Dividend Policy",
                format: "text",
                prompt: "What dividend policy applies? Identify any obligation or target distribution rate, working-capital reserve requirements, and any preferred dividend rights.",
            },
            {
                index: 9,
                name: "Transfer Restrictions",
                format: "text",
                prompt: "What restrictions apply to share transfers? Identify lock-up periods, prohibited transfers, permitted transfers (e.g. to affiliates), and any pre-emption / right of first refusal procedure.",
            },
            {
                index: 10,
                name: "Drag / Tag-Along",
                format: "text",
                prompt: "Are there drag-along or tag-along rights? State the threshold, exercise procedure, and any minority-protection conditions (e.g. minimum price).",
            },
            {
                index: 11,
                name: "Non-Compete on JV Partners",
                format: "text",
                prompt: "What non-compete obligations apply to the JV parties? Describe the scope (activities, geography), duration (during JV and post-exit), and any carve-outs.",
            },
            {
                index: 12,
                name: "Exit Mechanisms",
                format: "bulleted_list",
                prompt: "What exit mechanisms are contemplated? List each route (e.g. IPO, trade sale, drag sale, buyout via put/call, dissolution after term).",
            },
            {
                index: 13,
                name: "Term",
                format: "text",
                prompt: "What is the term of the JV? State the initial term, any extension mechanism, and any early-termination triggers (e.g. material breach, insolvency).",
            },
            {
                index: 14,
                name: "Governing Law",
            ...
            },
            {
                ...
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes resolved? Identify the forum, applicable rules, and any mandatory escalation steps before formal proceedings.",
            },
        ],
    },
    ...
    {
        id: "builtin-distribution",
        user_id: null,
        is_system: true,
        created_at: "",
        title: "Distribution / Reseller Agreement Review",
        type: "tabular",
        practice: "Commercial",
        prompt_md: null,
        columns_config: [
            {
                ...
                name: "Supplier",
                format: "text",
                prompt: "Who is the supplier or principal? State the full legal name and jurisdiction.",
            },
            {
                index: 1,
                name: "Distributor",
                format: "text",
                prompt: "Who is the distributor or reseller? State the full legal name and jurisdiction.",
            },
            {
                index: 2,
                name: "Territory",
                format: "text",
                prompt: "What is the territory in which the distributor may sell? State any geographic limitations and whether sales outside the territory are prohibited.",
            },
            {
                index: 3,
                name: "Products",
                format: "bulleted_list",
                prompt: "What products are covered by the agreement? Identify the product lines, models, or schedule references, and any rights of the supplier to add or remove products.",
            },
            {
                index: 4,
                name: "Exclusivity",
                format: "tag",
                tags: ["Exclusive", "Sole", "Non-Exclusive"],
                prompt: "Is the appointment exclusive, sole, or non-exclusive? Note any field- or channel-specific exclusivity and the supplier's reserved rights (e.g. direct sales to key accounts).",
            },
            {
                index: 5,
                name: "Minimum Purchase Commitments",
                format: "text",
                prompt: "Are there minimum purchase or sales targets? State the targets, the measurement period, and the consequences of failure (e.g. loss of exclusivity, termination right).",
            },
            {
                index: 6,
                name: "Pricing & Discounts",
                format: "text",
                prompt: "How is pricing structured? Identify list prices, distributor discounts, MAP (minimum advertised price) rules, currency, and any most-favoured-customer provisions.",
            },
            {
                index: 7,
                name: "Payment Terms",
                format: "text",
                prompt: "What payment terms apply? State the credit period, payment method, currency, late-payment interest, and any credit limits or security required.",
            },
            {
                index: 8,
                name: "Marketing Obligations",
                format: "text",
                prompt: "What marketing obligations are imposed? Identify minimum marketing spend, co-op marketing arrangements, required participation in trade shows, and approval rights over marketing materials.",
            },
            {
                index: 9,
                name: "Trademark Use",
                format: "text",
                prompt: "What trademark use rights are granted? State the scope of the licence, any brand-guideline compliance, approval rights, and quality control mechanisms.",
            },
            {
                index: 10,
                name: "Stock & Inventory",
                format: "text",
                prompt: "What inventory obligations apply? State minimum stock levels, forecasting obligations, and any rights of the supplier to repurchase or require destruction of stock on termination.",
            },
            {
                index: 11,
                name: "Warranties",
                format: "text",
                prompt: "What warranties pass through to end customers, and what warranties does the supplier give the distributor? Identify warranty duration, claims process, and remedy ladder.",
            },
            {
                index: 12,
                name: "Limitation of Liability",
                format: "text",
                prompt: "What liability limits apply between supplier and distributor? Identify the cap (and how calculated), exclusions of consequential loss, and any carve-outs.",
            },
            {
                index: 13,
                name: "Termination Rights",
                format: "text",
                prompt: "What are each party's termination rights? Distinguish termination for convenience (notice period) and termination for cause (cure periods, triggers). Note any minimum notice required by competition or distributor-protection laws.",
            },
            {
                index: 14,
                name: "Effect of Termination",
                format: "text",
                prompt: "What happens on termination? Address stock buyback/sell-off rights, return of marketing materials, customer-data handover, and ongoing warranty support.",
            },
            {
                index: 15,
                name: "Post-Termination Restrictions",
                format: "text",
                prompt: "What post-termination restrictions apply? Identify any non-compete or non-solicit obligations on the distributor, scope, geography, and duration.",
            },
            {
                index: 16,
                name: "Competition Law Flags",
                format: "text",
                prompt: "Flag any provisions that may raise competition / vertical-restraints issues (e.g. resale price maintenance, absolute territorial protection, online-sales bans, MFN clauses, hardcore restrictions under the Vertical Block Exemption Regulation or equivalent).",
            },
            {
                index: 17,
                name: "Governing Law",
            ...
            },
            {
                ...
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes resolved? Identify the forum, applicable rules, and any mandatory escalation steps.",
            },
        ],
    },
    ...
    // ─── Settlement & Release Agreement ──────────────────────────────────────────
    {
        ...
        is_system: true,
        created_at: "",
        title: "Settlement & Release Agreement Review",
        type: "tabular",
        practice: "Litigation",
        prompt_md: null,
        columns_config: [
            {
                ...
                name: "Parties",
                format: "bulleted_list",
                prompt: "Identify all parties to this settlement. For each, state full legal name and role (claimant, defendant, third-party).",
            },
            {
                index: 1,
                name: "Underlying Dispute",
                format: "text",
                prompt: "What is the underlying dispute or claim being settled? Summarise the proceedings (case number, court/tribunal), the cause of action, and the principal allegations.",
            },
            {
                index: 2,
                name: "Settlement Date",
                format: "date",
                prompt: "What is the date of the settlement agreement?",
            },
            {
                index: 3,
                name: "Settlement Sum",
                format: "monetary_amount",
                prompt: "What is the settlement amount? State the currency, the structure (lump sum, instalments, performance-based), the payment dates, and the recipient(s).",
            },
            {
                index: 4,
                name: "Tax Treatment",
                format: "text",
                prompt: "How is the settlement treated for tax purposes? Identify any allocation between heads of claim, any tax indemnity or gross-up provision, and any withholding obligations.",
            },
            {
                index: 5,
                name: "Scope of Release",
                format: "text",
                prompt: "What is the scope of the release? Identify whether it is mutual or one-way, the claims released (known/unknown, present/future), and the parties released (incl. affiliates, officers, employees).",
            },
            {
                index: 6,
                name: "Carve-Outs from Release",
                format: "bulleted_list",
                prompt: "What is expressly carved out from the release? List each carve-out (e.g. fraud, future obligations under the settlement itself, specific identified claims).",
            },
            {
                index: 7,
                name: "Confidentiality",
                format: "text",
                prompt: "What confidentiality obligations apply? Identify the scope of confidential information, permitted disclosures (legal advisers, regulators, tax authorities), duration, and consequences of breach.",
            },
            {
                index: 8,
                name: "Non-Disparagement",
                format: "text",
                prompt: "Is there a non-disparagement clause? Identify the parties bound, the scope (statements about each other, the underlying matter, the settlement), and any duration.",
            },
            {
                index: 9,
                name: "No Admission",
                format: "yes_no",
                prompt: "Does the agreement state there is no admission of liability? Answer Yes or No and quote the relevant language.",
            },
            {
                index: 10,
                name: "Future Cooperation",
                format: "text",
                prompt: "Are there any obligations of future cooperation (e.g. providing witness statements, supporting regulatory filings, attending depositions)? Describe the scope and any cost-allocation.",
            },
            {
                index: 11,
                name: "Indemnities",
                format: "text",
                prompt: "What indemnities are given (e.g. for breach of the release, for third-party claims by parties not party to the settlement)? Identify the indemnifier, scope, and any cap.",
            },
            {
                index: 12,
                name: "Tomlin / Consent Order",
                format: "yes_no",
                prompt: "Does the settlement contemplate a Tomlin order, consent order, or stay of proceedings? Answer Yes or No and identify the procedural mechanism for terminating the proceedings.",
            },
            {
                index: 13,
                name: "Costs",
                format: "text",
                prompt: "How are legal costs of the dispute and settlement handled? Identify whether each party bears its own costs, any agreed costs payment, and any waiver of costs orders previously made.",
            },
            {
                index: 14,
                name: "Withdrawal / Discontinuance",
                format: "text",
                prompt: "What steps must be taken to discontinue the underlying proceedings? Identify the timing, the form (notice of discontinuance, consent order), and which party files.",
            },
            {
                index: 15,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law applies to this settlement and which courts have jurisdiction over disputes arising from it?",
            },
            {
                index: 16,
                name: "Dispute Resolution",
                format: "text",
                prompt: "How are disputes about the settlement itself to be resolved? Identify the forum and any mandatory escalation steps.",
            },
        ],
    },

    // ─── Privacy Policy / DPA (GDPR) Compliance Check ────────────────────────────
    {
        id: "builtin-privacy-dpa",
        user_id: null,
        is_system: true,
        created_at: "",
        title: "Privacy Policy / DPA (GDPR) Compliance Check",
        type: "tabular",
        practice: "Privacy / Data",
        prompt_md: null,
        columns_config: [
            {
                index: 0,
                name: "Controller / Processor Designation",
                format: "tag",
                tags: ["Controller", "Processor", "Joint Controllers", "Sub-Processor", "Unclear"],
                prompt: "How are the parties characterised under GDPR / UK GDPR? Identify whether each party is a controller, joint controller, processor, or sub-processor, and whether the designation is consistent with the actual processing described.",
            },
            {
                index: 1,
                name: "Subject-Matter & Duration",
                format: "text",
                prompt: "What is the subject-matter and duration of the processing (Art. 28(3) GDPR)? Identify the nature and purpose of processing, and the period for which data will be processed.",
            },
            {
                index: 2,
                name: "Categories of Data Subjects",
                format: "bulleted_list",
                prompt: "What categories of data subjects are covered? List each (e.g. customers, employees, website visitors, prospects, end-users of the customer's services).",
            },
            {
                index: 3,
                name: "Categories of Personal Data",
                format: "bulleted_list",
                prompt: "What categories of personal data are processed? List each (e.g. contact details, account credentials, billing data, behavioural/usage data, device data).",
            },
            {
                index: 4,
                name: "Special-Category Data",
                format: "yes_no",
                prompt: "Is special-category data (Art. 9 GDPR) or criminal-conviction data (Art. 10) processed? Answer Yes or No, and if Yes identify the categories and the lawful basis (Art. 9(2)).",
            },
            {
                index: 5,
                name: "Lawful Basis",
                format: "bulleted_list",
                prompt: "What lawful bases (Art. 6) are relied on, and for which processing activities? List each basis and the processing it justifies.",
            },
            {
                index: 6,
                name: "Purposes of Processing",
                format: "bulleted_list",
                prompt: "List the stated purposes of processing. Flag any catch-all, secondary, or unspecified purposes that may not satisfy the purpose-limitation principle.",
            },
            {
                index: 7,
                name: "Sub-Processors",
                format: "text",
                prompt: "How are sub-processors handled? Identify the approval mechanism (general or specific authorisation), the notice / objection rights, the obligation to flow down equivalent terms, and whether a current sub-processor list is referenced.",
            },
            {
                index: 8,
                name: "International Transfers",
                format: "text",
                prompt: "What mechanism is used for international transfers of personal data? Identify the transfer tools relied on (e.g. SCCs 2021, UK IDTA / UK Addendum, EU-US Data Privacy Framework, adequacy decisions, BCRs) and the destination countries.",
            },
            {
                index: 9,
                name: "Data-Subject Rights",
                format: "text",
                prompt: "How are data-subject rights handled? Identify the processor's obligation to assist (Art. 28(3)(e)), the response timeline, and any cost-allocation.",
            },
            {
                index: 10,
                name: "Security Measures",
                format: "text",
                prompt: "What security measures are described (Art. 32 / TOMs)? Identify any specific standards (ISO 27001, SOC 2), encryption, access controls, and the level of detail provided.",
            },
            {
                index: 11,
                name: "Breach Notification",
                format: "text",
                prompt: "How is breach notification handled? Identify the timeline (e.g. 'without undue delay', 24 hours, 48 hours), the information to be provided, and any cooperation obligations.",
            },
            {
                index: 12,
                name: "Retention & Deletion",
                format: "text",
                prompt: "What retention and deletion obligations apply? Identify the retention periods, the deletion or return obligation on termination (Art. 28(3)(g)), and any retention exceptions (legal holds, statutory retention).",
            },
            {
                index: 13,
                name: "Audit Rights",
                format: "text",
                prompt: "What audit and inspection rights does the controller have over the processor? Identify frequency, notice, scope, and any reliance on third-party audit reports (e.g. SOC 2) in lieu of on-site audit.",
            },
            {
                index: 14,
                name: "Liability for DPA Breach",
                format: "text",
                prompt: "How is liability for breach of the DPA allocated? Identify any specific cap or carve-out for data-protection breaches, indemnities for regulatory fines, and the interaction with the main agreement's liability clause.",
            },
            {
                index: 15,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law applies to the DPA and which courts have jurisdiction?",
            },
        ],
    },
    ...
    {
        id: "builtin-term-sheet",
        user_id: null,
        is_system: true,
        created_at: "",
        title: "Term Sheet Comparison",
        type: "tabular",
        practice: "Corporate / Venture",
        prompt_md: null,
        columns_config: [
            {
                index: 0,
                name: "Investor",
                format: "text",
                prompt: "Who is the lead investor under this term sheet? State the fund name and identify any co-investors named.",
            },
            {
                index: 1,
                name: "Round Size",
                format: "monetary_amount",
                prompt: "What is the total round size? State the amount, currency, and any minimum/maximum range. Identify the lead investor's commitment versus the broader round.",
            },
            {
                index: 2,
                name: "Pre-money Valuation",
                format: "monetary_amount",
                prompt: "What is the pre-money valuation? State the amount and currency. Note whether the option pool is included in pre-money or post-money.",
            },
            {
                index: 3,
                name: "Post-money Valuation",
                format: "monetary_amount",
                prompt: "What is the post-money valuation? State the amount and currency.",
            },
            {
                index: 4,
                name: "Investor Equity %",
                format: "percentage",
                prompt: "What is the investor's resulting ownership percentage on a fully diluted basis (including the option pool)?",
            },
            {
                index: 5,
                name: "Liquidation Preference",
                format: "text",
                prompt: "What liquidation preference applies? State the multiple (e.g. 1x), whether participating or non-participating, any cap on participation, and the seniority relative to other share classes.",
            },
            {
                index: 6,
                name: "Anti-Dilution",
                format: "tag",
                tags: ["Full Ratchet", "Broad-based Weighted Average", "Narrow-based Weighted Average", "None"],
                prompt: "What anti-dilution protection applies? Identify the type (full ratchet, broad-based weighted average, narrow-based weighted average, or none) and any pay-to-play provision.",
            },
            {
                index: 7,
                name: "Dividend",
                format: "text",
                prompt: "What dividend rights apply to the investor's preferred shares? State the rate, whether cumulative or non-cumulative, and any participation in common dividends.",
            },
            {
                index: 8,
                name: "Board Seats",
                format: "text",
                prompt: "How many board seats does the investor receive? State the total board size, the breakdown (founder, investor, independent), and any observer rights.",
            },
            {
                index: 9,
                name: "Protective Provisions",
                format: "bulleted_list",
                prompt: "List the protective provisions / preferred-stock veto rights. Identify the threshold required (preferred majority, specific investor consent) and the matters covered.",
            },
            {
                index: 10,
                name: "Pro-Rata Rights",
                format: "text",
                prompt: "What pro-rata / pre-emption rights does the investor have on future rounds? State the scope (pro-rata of the investor's existing holding) and any super pro-rata or major-investor thresholds.",
            },
            {
                index: 11,
                name: "Drag-Along",
                format: "text",
                prompt: "What drag-along provision applies? State the threshold to trigger (board + majority shareholder consent), any conditions (minimum price, common share return), and any minority protections.",
            },
            {
                index: 12,
                name: "Tag-Along",
                format: "text",
                prompt: "What tag-along rights apply? Identify the trigger, the scope (proportionate or full tag), and any thresholds.",
            },
            {
                index: 13,
                name: "Information Rights",
                format: "text",
                prompt: "What information rights does the investor receive? Identify financial reporting (monthly/quarterly/annual), inspection rights, and any major-investor threshold.",
            },
            {
                index: 14,
                name: "ROFR / Co-sale",
                format: "text",
                prompt: "Are there rights of first refusal / co-sale rights on founder transfers? Describe the procedure and any carve-outs (permitted transfers).",
            },
            {
                index: 15,
                name: "Founder Vesting",
                format: "text",
                prompt: "What founder vesting applies? State the total vesting period, any cliff, the treatment of pre-funding service, and acceleration on termination, change of control, or both.",
            },
            {
                index: 16,
                name: "Option Pool",
                format: "text",
                prompt: "What option pool refresh is required? State the post-money option pool size, whether it is created pre-money (founder dilution) or post-money (all-shareholder dilution), and any unallocated-option requirements.",
            },
            {
                index: 17,
                name: "Exclusivity / No-Shop",
                format: "text",
                prompt: "Is there an exclusivity / no-shop clause? State the duration, the activities restricted, any carve-outs, and any break fees.",
            },
            {
                index: 18,
                name: "Conditions Precedent",
                format: "bulleted_list",
                prompt: "List the conditions precedent to closing (e.g. due diligence, definitive documents, IP assignment by founders, no MAC, regulatory consents).",
            },
            {
                index: 19,
                name: "Governing Law",
                format: "text",
                prompt: "What governing law and jurisdiction will apply to the definitive transaction documents?",
            },
        ],
    },

    // ─── Redline / Negotiation Playbook Generator ────────────────────────────────
    {
        id: "builtin-redline-playbook",
        user_id: null,
        is_system: true,
        created_at: "",
        title: "Redline / Negotiation Playbook Generator",
        type: "assistant",
        practice: "General",
        prompt_md:
            "## Redline / Negotiation Playbook\n\n" +
            "Compare the uploaded draft agreement against the user-supplied or attached market-standard template / firm playbook (or, if none is provided, against well-known market-standard positions for this type of agreement) and produce a negotiation memo.\n\n" +
            "Before starting, ask the user (only if not already specified): (a) which side they represent (e.g. buyer, seller, lender, lessee, customer, vendor), and (b) whether they want a STRICT redline (only material deviations) or a COMPREHENSIVE memo (every notable clause).\n\n" +
            "You MUST use the generate_docx tool to produce the output as a downloadable Word document. Pass landscape: false. Structure the document with a heading per clause cluster. For each material clause, include a four-row table with these columns:\n\n" +
            "1. **Clause / Topic** — clause number and short label (e.g. '14.2 Limitation of Liability — Cap')\n" +
            "2. **Draft Position** — the exact language from the uploaded draft (quoted)\n" +
            "3. **Market Standard / Preferred Position** — the market or playbook position for the user's side\n" +
            "4. **Assessment** — Favourable / Neutral / Unfavourable to the user's side, with a one-sentence reason\n\n" +
            "Below each table, include a 'Fall-back Positions' bullet list with three tiers: **Best** (ideal redline language), **Acceptable** (compromise position), **Walk-Away** (worst position that should still be accepted). Include redline-ready replacement language in quotes.\n\n" +
            "Group clauses under these themes (omit any not present in the document): **Commercial Terms**, **Risk Allocation**, **IP & Data**, **Termination & Renewal**, **Boilerplate & Dispute Resolution**.\n\n" +
            "End the memo with a 'Deal-breakers' section flagging any provision that should be rejected outright, and a 'Strategic Notes' section with any negotiation tactics relevant to the deal context (e.g. leverage points, sequencing of asks, what to concede first).",
        columns_config: null,
    },

    // ─── Closing Checklist Generator ─────────────────────────────────────────────
    {
        id: "builtin-closing-checklist",
        user_id: null,
        is_system: true,
        created_at: "",
        ...
        prompt_md:
            "## Closing Checklist Generator\n\n" +
            "Review the uploaded transaction document(s) (e.g. SPA, APA, credit agreement, shareholder agreement, real-estate purchase agreement) and generate a comprehensive closing checklist.\n\n" +
            "You MUST use the generate_docx tool to produce the checklist as a downloadable Word document. You MUST pass landscape: true — the document must be in landscape orientation. Do not display the checklist inline.\n\n" +
            "Extract every signing-day deliverable, condition precedent, regulatory consent, third-party consent, ancillary document, and post-closing covenant from the document(s). Capture corporate authorisations (board / shareholder resolutions), tax filings, IP assignments, security documents, completion-day undertakings, and any conditions subsequent.\n\n" +
            "Structure the document as follows:\n" +
            "- Group items by category, each with its own heading: **Corporate**, **Financial**, **Regulatory & Anti-trust**, **Tax**, **Real Estate**, **IP**, **Employment**, **Security & Guarantees**, **Conditions Subsequent / Post-Closing**\n" +
            "- Under each category heading, include a table with exactly these six columns in this order:\n" +
            "  1. Index — sequential number within the category (1, 2, 3…)\n" +
            "  2. Item — concise description of the deliverable / condition\n" +
            "  3. Responsible Party — who must produce or procure it (e.g. Seller, Buyer, Target, External Counsel, Tax Adviser)\n" +
            "  4. Reference — clause or schedule reference in the underlying document\n" +
            "  5. Status — leave blank (empty string) for the user to fill in (e.g. Outstanding / In Progress / Complete)\n" +
            "  6. Notes — leave blank for the user to track follow-ups\n\n" +
            "Use the table field in the section object (not content) for each category's rows. Skip any category that has no items. At the start of the document, include a brief one-paragraph summary of the transaction (parties, headline value, target completion date) for quick context.",
        columns_config: null,
    },
